...
export interface PaymentMadeStore {
  currentPage: number;
  itemsPerPage: number;
  sortBy: string;
  sortDirection: "asc" | "desc";
  filters: Record<string, string>; // filtros dinámicos: "search", "method", etc.
...
export const usePaymentMadeStore = create<PaymentMadeStore>((set) => ({
  currentPage: 1,
  itemsPerPage: 12,
  sortBy: "paymentDate",
  sortDirection: "desc",
